...
export const featuresData: FeatureItem[] = [
	{
		...
		question:
			"How do we build a slider so that a non-technical user can easily add new slides later without breaking the layout?",
	...
	},
	{
		...
		question:
			"How do we keep the slider spinning smoothly like a carousel without snapping or visually rewinding when it reaches the last slide?",
